  ...
  return useMutation({
    mutationFn: async (payload) => {
      try {
        ...
        throw new Error(messageFromFastApiDetail(err.detail) || "Failed to create department");
      }
    },
    onSuccess: () => {
  ...
  return useMutation({
    mutationFn: async (id) => {
      try {
        ...
        throw new Error(messageFromFastApiDetail(err.detail) || "Failed to delete department");
      }
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["departmentList"] });
